...
<body class="bg-light">
    <div style="height: 100vh">
        <div class="row h-100 m-0">
            <div class="card w-25 my-auto mx-auto">
                <div class="card-headder bg-white border-0 py-3">
                ...
                <p class="text-center mt-3 small">Resisterd already
 ...
 <!-- CDN for Javescript / Online Bootstrap -->   
